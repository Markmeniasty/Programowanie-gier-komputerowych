...
Uruchomienie
Otwórz projekt w Godot Engine 4.x.

Upewnij się, że w Inspektorze węzła Enemy przypisane są sceny DeathParticles.tscn oraz EnemyBullet.tscn.

Uruchom scenę główną (main.tscn) za pomocą klawisza F5.

Sterowanie: Strzałki/WSAD do poruszania się, Spacja (ui_accept) do strzelania.
